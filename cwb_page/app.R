  ...
  "))
                ...
                fluidRow(
                  ...
                  column(10, align = "center",
                         HTML("<b style='font-size:2rem;face:italic'>How to interpret the cards</b><br><br>"),
                ...
                br(),
                br(),
                fluidRow(class="first-set", 
                         column(1),
                         column(10, uiOutput("material_boxes") %>% withSpinner(color="#0dc5c1")),
                         column(1)
                ),
                br(),
                fluidRow(
                  column(1),
                  column(10, uiOutput("quality_boxes") %>% withSpinner(color="#0dc5c1")),
                  column(1)
                ),
                br(),
                fluidRow(
                  column(1),
                  column(10, uiOutput("community_boxes") %>% withSpinner(color="#0dc5c1")),
                  column(1)
                ),
                br(),
                # hr(),
