                ...
                fluidRow(align = "center",
                         ...
                         fluidRow(
                           ...
                           column(3, radioButtons("allToggle", 
                                                  ...
                                                  choiceNames = list(HTML("Afficher uniquement <span style='text-decoration: underline dotted' class='head-show'>les indicateurs principaux</span><span class='head-hide'>Les indicateurs principaux sont les 24 indicateurs les plus représentatifs du bien-être actuel dans la base de données</span>"),
  ...
  observeEvent(c(input$countrySelector, input$allToggle, input$orderButton), {
    ...
    cardBuilder <- function(point_avg, ts_avg, cluster_name) {
      ...
      if(cluster_name == "material") {
        ...
        cluster_html <- HTML(paste("<span class='cluster-header' style='font-size:22px;color:#101d40!important;'>Conditions de vie matérielles ", countryName(),"</span>
                              <br>
                              Éléments qui déterminent les caractéristiques économiques individuelles, comme le revenu et le patrimoine, le logement, le travail et la qualité de l’emploi.
                              <br>
                              <br>"))
        ...
        cluster_html <- HTML(paste("<br>
                              <span class='cluster-header' style='font-size:22px; color:#101d40!important;'>Qualité de vie ", countryName(), "</span>
                              <br>
                              Éléments qui reflètent la qualité de vie des individus : santé, connaissances et compétences, qualité de l'environnement, bien-être subjectif et sécurité.
                              <br>
                              <br>"))
        ...
        cluster_html <- HTML(paste("<br>
                              <span class='cluster-header' style='font-size:22px; color:#101d40!important;'>Relations sociales ", countryName(),"</span>
                              <br>
                              Éléments qui montrent le degré d’interaction et la vie sociale des individus, ainsi que la façon dont ils occupent leur temps : équilibre travail-vie privée, liens sociaux et engagement civique.
                              <br>
                              <br>"))
